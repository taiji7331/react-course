...
However, if you then subsequently click on the "Open Development Server" link at the very bottom of the code lab (on the blue-colored status bar at the very bottom), you'll get a blank page served instead of the app.

Don't worry about this. What it means is that the app cannot compile because you still need to add the missing named import, like the code comments on lines 2 and 3 of App.js instruct.
